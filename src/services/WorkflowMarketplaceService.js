...
const workflowTemplates = [
  {
    ...
    description:
      'An intelligent customer support workflow with request handling, sentiment analysis, and appropriate routing.',
  ...
  },
  {
    ...
    description:
      'A comprehensive data processing workflow including data cleaning, analysis, and visualization components.',
  ...
  },
  {
    ...
    description:
      'AI-powered content moderation workflow with toxicity detection, policy compliance, and human review integration.',
  ...
  },
  {
    ...
    description:
      'Automated lead qualification and scoring workflow to identify high-value prospects.',
    category: 'sales',
  ...
  },
  {
    ...
    description:
      'Extract, analyze, and summarize information from various document formats with NLP capabilities.',
  ...
  },
  {
    ...
    description:
      'AI-powered recruitment workflow that screens resumes, schedules interviews, and provides candidate evaluations.',
    category: 'hr',
...
export const importWorkflowTemplate = async (templateId) => {
  return new Promise((resolve, reject) => {
    setTimeout(() => {
        ...
        importedWorkflow = {
          nodes: [
            ...
            // Initial Support Agent
            {
              ...
              parameters: {
                systemPrompt:
                  "You are a customer support agent. Be helpful and polite. Determine the nature of the customer's issue.",
              },
            },
            ...
            // Technical Support Agent
            {
              ...
              parameters: {
                systemPrompt:
                  'You are a technical support specialist. Help customers troubleshoot and resolve technical issues.',
              },
            },
            ...
            // Billing Support Agent
            {
              ...
              parameters: {
                systemPrompt:
                  'You are a billing support specialist. Help customers with billing inquiries and payment issues.',
              },
            },
        ...
        importedWorkflow = {
          nodes: [
            ...
            // Model for agent
            {
              id: `model-${Date.now()}`,
              type: 'model',
              name: 'GPT-5 Model', // Aggiornato
              modelType: 'gpt-5', // Aggiornato
            ...
            // Memory for agent
            {
              id: `memory-${Date.now()}`,
              type: 'memory',
              name: 'Short Memory', // Aggiornato
              memoryType: 'short-memory', // Aggiornato
      ...
      const templateIndex = workflowTemplates.findIndex(
        (t) => t.id === templateId
      );
      if (templateIndex !== -1) {
...
export const rateWorkflowTemplate = async (templateId, rating) => {
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      ...
      workflowTemplates[templateIndex].rating = parseFloat(
        newRating.toFixed(1)
      );
